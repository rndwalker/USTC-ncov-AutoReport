...
def report(username, password, data_path='./data.json', max_tries=10):
	# Login
	token = ''
	login = None
...
if __name__ == '__main__':
	...
	parser.add_argument(
		'--data_path', help='path to your own data.json', type=str, default='./data.json')
	parser.add_argument(
		'--max_tries', help='max tries as in reports', type=int, default=10)
	args = parser.parse_args()
	exit(report(username=args.username, password=args.password, data_path=args.data_path,
